                    ...
                    <div class="row">
                        <div class="col-xl-auto col-md-12 col-sm-12 col-xs-12 justify-content-center">
                            <div class="form-group">
                                <img class="rounded" width="400" height="560"
                                    src="<?php echo base_url(); ?>asset/images/book/<?php echo $book['image_book'] ?>">
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="id" name="id"
                                    value="<?php echo $book['id_book']; ?>">
                                <input type="hidden" class="form-control" id="deleted" name="deleted"
                                    value="<?php echo $book['deleted']; ?>">
                            </div>
                            <div class="form-group">
            ...
            <div class="collapse show" id="chapter" aria-expanded="false">
                <div class="card-body">
                    <ul>
                        ...
                        <li><a href="#" class="text-success">Chapter <?php echo $data['number_chapter'] ?>:
                                <?php echo $data['name_chapter'] ?></a><?php echo $data['created_datetime'] ?></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            </div>
