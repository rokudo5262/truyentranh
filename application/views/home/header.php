            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <?php foreach ($genre as $data) : ?>
                        <a href="<?php echo base_url(); ?>main/genre/<?= $data['id_genre'] ?>" type="submit" class="dropdown-item btn btn-primary"><?= $data['name_genre'] ?></a>
                    <?php endforeach; ?>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <?php foreach ($status as $data) : ?>
                        <button type="button" class="dropdown-item btn btn-primary" value=""><?= $data['name_status'] ?></button>
                    <?php endforeach; ?>
                </div>
            </li>
            <li class="nav-item">
